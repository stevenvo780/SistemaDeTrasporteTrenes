...
class LineaMetro:
    def __init__(self, num_estaciones, num_trenes, capacidad_tren, tamano_espacio):
        self.estaciones = self.generar_estaciones(num_estaciones, tamano_espacio)
        self.trenes = [Tren(self.estaciones, capacidad_tren, VELOCIDAD_TREN) for _ in range(num_trenes)]
